            ...
            <div class="col-12 col-md-8 col-lg-6">
                ...
                <div class="card bg-white border-0 shadow rounded-0">
                    ...
                    <div class="card-header border-0 bg-white">
                        <h5 class="card-title text-center pt-2">Start your secured session</h5>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row row-cols-1 row-cols-md-3 g-2">
                            ...
                            <div class="col">
                                <button class="btn btn-outline-danger w-100 text-start rounded-5"><i class="fab fa-google me-2"></i>Google</button>
                            </div>
                            
                            <div class="col">
                                <button class="btn btn-outline-dark w-100 text-start rounded-5"><i class="fab fa-github me-2"></i>Github</button>
                            </div>
                            
                            <div class="col">
                                <button class="btn btn-outline-primary w-100 text-start rounded-5"><i class="fab fa-facebook me-2"></i>Facbook</button>
                            </div>
                    ...
                    <div class="card-footer text-center py-3 bg-white border-0">
                        Create free OsamaGenius <a class="text-decoration-none" href="{{route('register')}}">account here</a>
                    </div>
