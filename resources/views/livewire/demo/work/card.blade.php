<div>
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-3 mb-4 position-relative">
            ...
            <div class="col" wire:key="{{$project->id}}" data-cate="{{$project->category}}">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-1">
                        <img src="{{ asset('imgs/skills.png') }}" alt="temp" class="card-img aspect-square object-cover" />
                        <div class="py-3 px-2">
                            ...
                            <div class="text-end">
                                <div class="btn-group">
                                    <a href="{{$project->project_url}}" target="__blank" class="btn btn-outline-primary">
        ...
        <div class="position-absolute show-all-btn">
            <a href="#" class="btn btn-outline-success rounded-5 overflow-hidden">
