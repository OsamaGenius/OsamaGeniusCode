...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="container">
            ...
            {{-- Responsive Button --}}
            <button class="navbar-toggler" data-bs-target="#OsamaGeniusLinks" data-bs-toggle="collapse"
            ...
            <div id="OsamaGeniusLinks" class="collapse navbar-collapse">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @guest
                        <li class="nav-item">
                            <a href="{{ route('login') }}" class="nav-link @if (Route::currentRouteName() === 'login') active @endif">
                                Login
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    @else
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdawon" aria-labelledby="dropdownId">
                                <div class="text-center my-3">
                                    @if (Auth::guard('web')->user()->image !== null)
                                        <img src="{{ asset('/storage/' . Auth::guard('web')->user()->image) }}"
                                            alt="">
                                    @else
                                ...
                                <h4 class="text-center mb-0 pb-0">{{Auth::guard('web')->user()->name}}</h4>
                                <p class="text-center mt-0 pt-0"><small>{{Auth::guard('web')->user()->email}}</small></p>
                                <hr>
        ...
        <div class="container">
                    ...
                    <div class="row row-cols-2 g-3">
                        ...
                        <div class="col">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    <a class="text-decoration-none" href="contact.html">Contact Me</a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row py-3">
                ...
                <div class="col-12 col-md-8 col-lg-6">
                    ...
                    {{-- Topic Description --}}
                    <div class="form-floating mb-3">
                        <textarea class="form-control" name="body" id="body" placeholder="Your description"></textarea>
